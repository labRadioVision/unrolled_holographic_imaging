# -*- coding: utf-8 -*-
"""
run_wlista_synthetic_muscle.py
==============================
...
Run:
    python run_wlista_synthetic_muscle.py > wlista_muscle.log 2>&1

    # resume from checkpoint
    python run_wlista_synthetic_muscle.py \\
...
import base_pec_nowalls as base
